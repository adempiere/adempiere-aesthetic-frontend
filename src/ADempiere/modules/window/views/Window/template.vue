    ...
    <el-container style="height: 86vh;">
      ...
      />
        <component
          ...
          :source-field="currentFieldOption.fieldAttributes"
          :record-uuid="currentFieldOption.fieldAttributes.recordUuid"
...
<style lang="scss" src="./style/windowStyleGlobal.scss"></style>
<style lang="scss" scoped src="./style/windowStyleScoped.scss"></style>
