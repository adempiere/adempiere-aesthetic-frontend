<template>
  <div
    v-if="!isEmptyValue(getProcessLog)"
    key="with-process"
    class="app-container"
  >
    <el-timeline>
        ...
        <el-card>
            ...
            <div class="actions">
              <el-dropdown @command="handleCommand">
                ...
                <el-dropdown-menu slot="dropdown">
                  ...
                  <el-dropdown-item
                    :command="{...activity, command: 'zoomIn'}"
                  >
          ...
          <el-form label-position="top">
            <el-form-item
              ...
              :label="generateTitle('Description')"
            >
              <span
                ><b>{{ activity.description }}</b></span
              >
            ...
            <el-form-item :label="generateTitle('Status')">
              ...
              <el-popover
                ...
                trigger="click"
              >
                <b>{{ $t('table.ProcessActivity.Logs') }}</b
                ><br />
                <ul>
                  <li
                    @click="handleCommand({...activity, command: 'zoomIn'})"
                  >
                    {{ activity.summary }}
                  </li>
              ...
              >
                <div v-if="!isEmptyValue(activity.summary)">
                  ...
                  <span
                    >{{ $t('table.ProcessActivity.Name') }}:
                    {{ activity.output.name }}</span
                  ><br />
                  <span
                    >{{ $t('table.ProcessActivity.Description') }}:
                    {{ activity.output.description }}</span
                  ><br />
                  <span
                    >{{ $t('table.ProcessActivity.FileName') }}:
                    {{ activity.output.fileName }}</span
                  ><br />
                  <a
                    type="text"
                    :href="activity.url"
