        ...
        <el-main style="padding: 0px !important; overflow: hidden;">
            <el-container style="height: 100%;">
                <el-header :style="tableHeaderStyle">
                    ...
                    >
                        <el-collapse-item
                            :title="$t('table.dataTable.advancedQuery')"
                            name="PanelAdvancedQuery"
                        >
                            <main-panel
                                v-if="
                                    isLoadedPanel ||
                    ...
                    <div v-if="!isMobile">
                        ...
                        />
                        <div
                            :class="{show: showTableSearch}"
                            class="local-search-container"
                        >
                            <svg-icon
                    ...
                    <div v-else>
                        ...
                        <div v-else class="panel-expand">
                            ...
                            <el-button
                                v-show="
                                    isPanelWindow && getDataSelection.length
                                "
                                type="text"
                                icon="el-icon-delete"
                ...
                <el-main style="padding: 0px !important; overflow: hidden;">
                    <table-context-menu
                        ...
                        :style="{
                            left: leftContextualMenu + 'px',
                            top: topContextualMenu + 'px'
                        }"
                                ...
                                <template slot-scope="scope">
                                    ...
                                    <template v-else>
                                        <el-tag
                                            ...
                                            :style="
                                                getFieldDefinition(
                                                    fieldAttributes.fieldDefinition,
                                                    scope.row
                                                )
                                            "
                                            :type="
...
<style lang="scss" src='./Style/dataTables-StyleScoped.scss'></style>
<style lang="scss" scoped src="./Style/dataTables-StyleScoped.scss"></style>
